...
#      - writes various output files for simulation/synthesis/debug
#
#
#  - linker output files:
#      - <file>.vh1 = VHDL file with initialized array holding memory data
#      - <file>.vh2 = VHDL file with INIT_XX constants for Xilinx Block RAM
#      - <file>.cmd = YARDBUG command file to load program into RAM
#
#
#-------------------------------------------------------------------------------
...
package mem_dat_pkg is
  ...
  constant MEM_SIZE : natural := $mem_size_32 ;
