...
::
:: settings from smartxplorer run   ( t 7 )
::
::map  -intstyle xflow     -p xc3s200-ft256-4 -timing -ol high -t 7 -o evb_map.ncd evb.ngd evb.pcf
::if errorlevel 1 exit /b 1
::
::par  -intstyle xflow     -w -ol high -t 7 evb_map.ncd evb.ncd evb.pcf
::if errorlevel 1 exit /b 1
::


trce -intstyle xflow     -v 99 -s 4 -xml evb evb.ncd -o evb.twr evb.pcf -ucf ..\..\evb.ucf
if errorlevel 1 exit /b 1
